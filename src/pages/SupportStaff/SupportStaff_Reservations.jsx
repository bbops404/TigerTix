...
import SupportStaff_ReservationScanQRPopUp from "./SupportStaff_ReservationScanQRPopUp.jsx";
import SupportStaff_ReservationsFilter from "./SupportStaff_ReservationsFilter.jsx";
...
const SupportStaff_Reservations = () => {
    ...
    <div className="flex flex-col bg-[#1E1E1E] min-h-screen text-white font-Poppins">
      ...
      <div className="flex">
        ...
        <div className="flex-1 px-10 py-10">
          ...
          {/* Filter Component */}
          {showFilter && (
            <SupportStaff_ReservationsFilter
      ...
      {/* QR Code Popup */}
      {showQRPopup && (
        <SupportStaff_ReservationScanQRPopUp
...
export default SupportStaff_Reservations;
