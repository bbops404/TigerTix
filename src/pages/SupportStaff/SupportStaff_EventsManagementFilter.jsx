...
const SupportStaff_EventManagementFilter = ({ showFilter, setShowFilter }) => {
      ...
      <div className="w-80 h-full bg-white shadow-lg transform transition-transform duration-300">
        <div className="p-6 text-black relative">
          ...
          <div className="space-y-3">
            {["Event Category", "Event Type", "Venue"].map((field) => (
              <select
                key={field}
                name={field}
...
export default SupportStaff_EventManagementFilter;
