  ...
  return (
    <div className="bg-[#202020] text-white min-h-screen">
      ...
      <div className="p-16 max-w-5xl mx-auto text-gray-300 font-Poppins">
        ...
        <h2 className="text-2xl font-semibold text-center mt-2">Privacy Policy</h2>

        <div className="mt-10 space-y-10">
          <section className="text-left">
            <h3 className="text-xl font-semibold">1. Information We Collect</h3>
            <p className="mt-2"><strong>1.1 Personal Information</strong></p>
            ...
            <p className="mt-2"><strong>1.2 Non-Personal Information</strong></p>
            <ul className="list-disc pl-8">
              <li>Device Information (e.g., browser type, operating system)</li>
              <li>Usage Data (e.g., pages visited, features used)</li>
              <li>Cookies and similar tracking technologies</li>
            </ul>
            <p className="mt-2"><strong>1.3 Payment Information</strong></p>
            <p>If applicable, we may collect payment details for ticket reservations. Payment processing is handled by third-party providers and is subject to their privacy policies.</p>
          </section>
          ...
          <section className="text-left">
            <h3 className="text-xl font-semibold">3. How We Share Your Information</h3>
          ...
          <section className="text-left">
            ...
            <p>We retain your information only as long as necessary for the purposes outlined in this Privacy Policy or as required by law. Upon request, we will delete your data unless it is required for legitimate business or legal purposes.</p>
          </section>
          ...
          <section className="text-left">
            ...
            <p>We implement appropriate technical and organizational measures to protect your data from unauthorized access, alteration, disclosure, or destruction. However, no method of transmission or storage is 100% secure.</p>
          </section>

          <section className="text-left">
            <h3 className="text-xl font-semibold">7. Third-Party Links</h3>
            <p>TigerTix may contain links to third-party websites or services. We are not responsible for their privacy practices or content. Please review their privacy policies before sharing your information.</p>
          </section>

          <section className="text-left">
            <h3 className="text-xl font-semibold">8. Updates to This Privacy Policy</h3>
          ...
          <section className="text-left">
            ...
            <p><strong>TigerTix Support Team</strong></p>
            <p>Email: [Insert Email Address]</p>
            <p>Phone: [Insert Phone Number]</p>
          </section>

          <p className="mt-10 text-center">By using TigerTix, you agree to the terms of this Privacy Policy. If you do not agree, please refrain from using our services.</p>
        </div>
      </div>
    </div>
  );
