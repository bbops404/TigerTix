      ...
      <div className="p-16 max-w-5xl mx-auto text-gray-300 font-Poppins">
        ...
        <div className="mt-10 space-y-10">
          <section className="text-left">
            ...
            <p>
              You must be a currently enrolled student, staff member, or an
              authorized user to access and use TigerTix. By using the platform,
              you confirm that all information you provide is accurate and
              up-to-date.
            </p>

            <p className="mt-2">
              <strong>1.2 Account Responsibility</strong>
            </p>
            <p>
            ...
            <p className="mt-2">
              <strong>1.3 Prohibited Activities</strong>
            </p>
          ...
          <section className="text-left">
            ...
            <p className="mt-2">
              <strong>2.1 Ticket Availability</strong>
            </p>
            <p>
              Ticket reservations are subject to availability and are allocated
              on a first-come, first-served basis.
            </p>

            <p className="mt-2">
              <strong>2.2 Fees and Payments</strong>
            </p>
            <p>
              Some events may require payment. All transactions are final unless
              otherwise stated. We are not responsible for errors in payment
              processing by third-party services.
            </p>

            <p className="mt-2">
              <strong>2.3 Cancellations and Refunds</strong>
            </p>
            <p>
              Cancellation and refund policies vary by event. Refer to the event
              organizer’s terms for specifics.
            </p>
          </section>
          ...
          <section className="text-left">
            ...
            <p>
              All content on TigerTix, including logos, designs, text, and
              software, is our property or that of our licensors and is
          ...
          <section className="text-left">
            ...
            <p>
              TigerTix is provided on an "as-is" and "as-available" basis. We
              make no warranties of any kind, express or implied, about:
            </p>
            <ul className="list-disc pl-8">
          ...
          <section className="text-left">
            ...
            <p>
              ...
              TigerTix at our discretion if you violate these Terms of Use or
              engage in activities that harm the platform or its users.
            </p>
          </section>
          ...
          <section className="text-left">
            ...
            <p>
              ...
              of TigerTix signifies your acceptance of the revised terms.
            </p>
          </section>
          ...
          <section className="text-left">
            ...
            <p>
              These Terms of Use are governed by the laws of [Insert
