        ...
        <div className="mt-10 flex flex-col md:flex-row items-center gap-10">
          <div className="md:w-1/2 text-gray-300 text-justify">
            <p>
              ...
              process, eliminating long queues, and ensuring smooth reservations
              for high-demand events like UAAP games. By leveraging technology,
              TigerTix empowers both users and organizers with features that
              streamline event management, creating an efficient and enjoyable
              experience for all.
            </p>
          </div>
