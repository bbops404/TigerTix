...
const Label = ({ label, value }) => {
  return (
    <div className="w-full grid grid-cols-[20%_80%]  items-start py-2 gap-2 font-semibold">
      ...
      <div className="bg-gray-100 text-gray-900 text-left p-2 rounded-lg shadow-md">
        {value}
      </div>
    </div>
  );
    ...
    <div className="flex flex-col min-h-screen bg-[#202020]">
      ...
      <div className="flex flex-col justify-center items-center flex-grow">   
        ...
        <div className="w-[90vw] max-w-[1200px] h-[600px] flex flex-col items-center  rounded-lg relative">
          ...
          {/* Profile Card */}
          <div className="w-full h-[75%] pt-12 md:pt-13 lg:pt-16 px-6 md:px-12 pb-9 bg-white flex flex-row rounded-lg shadow-lg text-center mt-auto">
            <div className="w-[30%] max-w-[300px] h-full flex flex-col justify-start items-center py-6 px-7 gap-6 text-lg font-semibold text-gray-900">
              <button className="w-full py-1 px-5 justify-center cursor-pointer transition duration-300 flex rounded-full bg-[#FFAB40] shadow-md">
                Account Details
              </button>
              <button
                className="w-full py-1 px-5 justify-center cursor-pointer hover:bg-[#FFAB40] transition duration-300 flex rounded-full bg-[#F1F1F1] shadow-md"
