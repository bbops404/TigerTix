    ...
    return (
        <div className="flex">
            ...
            <div className="w-1/2 p-4 ml-6">
                <h1 className="text-2xl font-bold text-center">RESERVE FOR THE BIG GAME!</h1>
                ...
                <div className="mt-4">
                    ...
                    <div className="flex gap-2 mt-2">
                        {Object.keys(ticketPrices).map((type) => (
                            <button
                                key={type}
                                className={`px-6 py-1 rounded-full font-Poppins text-[#F09C32] font-semibold ${ticketType === type ? "bg-[#F09C32] text-black" : "bg-black text-white"}`}
